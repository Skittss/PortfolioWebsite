								...
								<div>
									<Row wrap={false}>
										<Col flex={1}>
											<Row wrap={false}>
												...
												<Col>
													...
													<Row align="middle">
														<span style={{fontSize: 10, color: 'gray'}}>BSc (Hons) Computer Science</span>
													</Row>
												</Col>
											</Row>
										</Col>
										...
										<Row style={{height: "100%", display: "flex", alignItems: "center", justifyContent: screens.md ? "left" : "center"}}>
											...
											<Col style={{background: "rgba(0,0,0,0.5)", borderRadius: "0.4em", padding: "2px 5px 2px 5px", fontFamily: "'Roboto Mono', monospace"}}>&gt; Vulkanizing 🌱<span className="animated-cursor" /></Col>
										</Row>
										</Col>
									</Row>
								</div>
