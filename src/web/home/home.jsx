					...
					<Col style={{textAlign: screens.md ? "left" : "center", verticalAlign: screens.md? "middle" : "top"}}>
						<div style={{height: "100%", display: "flex", alignItems: "center", justifyContent: screens.md ? "left" : "center", maxWidth: "500px"}}>
							<div className="styled-text">
								...
								<p style={{marginBottom: "5px"}}>I'm into low-level graphics systems, and higher level techniques at the intersection of graphics and art.</p>
								...
								<div>
									<Row wrap={false}>
										...
										<Row style={{height: "100%", display: "flex", alignItems: "center", justifyContent: screens.md ? "left" : "center"}}>
											...
											<Col style={{background: "rgba(0,0,0,0.5)", borderRadius: "0.4em", padding: "2px 5px 2px 5px", fontFamily: "'Roboto Mono', monospace"}}>&gt; Generating Cubes 🧊<span className="animated-cursor" /></Col>
										</Row>
										</Col>
									</Row>
								</div>
